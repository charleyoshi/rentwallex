    ...
    return (
        <div className='ourMap'>
            ...
            <div className='mapContentWrapper'>
                    ...
                    {isShowingDetail ?
                        ...
                        <div className="place-dropdowns">
                            <div className="dropdown">
                                <select value={selectedCity} name="city" onChange={handleCityChange}>
                            ...
                            <div className="dropdown">
                                <select value={selectedProvince} name="province" onChange={handleProvinceChange}>
                ...
                <div className="right">
                    <Map onGoogleApiLoaded={onGoogleApiLoaded} coordinates={items} updateMap={onClickOneItem} handlePinHover={handlePinHover} handleBoundsChanged={handleBoundsChanged} />
                </div>
            </div>
          )}
          {items.map(
